...
exports.parseMetadataAiResponse = exports.buildMetadataAiPrompt = exports.validateMetadataAiInput = void 0;
function normalizedField(value, label, maxLength, required = false) {
...
function validateMetadataAiInput(data) {
...
exports.validateMetadataAiInput = validateMetadataAiInput;
function buildMetadataAiPrompt(input) {
...
exports.buildMetadataAiPrompt = buildMetadataAiPrompt;
function parseMetadataAiResponse(rawText) {
    var _a;
    const raw = typeof rawText === "string" ? rawText.trim() : "";
    const jsonText = ((_a = raw.match(/\{[\s\S]*\}/)) === null || _a === void 0 ? void 0 : _a[0]) || "";
    if (!jsonText) {
...
exports.parseMetadataAiResponse = parseMetadataAiResponse;
//# sourceMappingURL=metadata_ai.js.map